      ...
      *| DATE GENERATED: 05/18/2021 09:51                              |
      ...
      *+---------------------------------------------------------------+
      *| TEST_SQL913                                                   |
      *|     THIS PROGRAM IS FOR TEST SQL913                           |
      *+---------------------------------------------------------------+
       IDENTIFICATION DIVISION.
       PROGRAM-ID. 'TEST_SQL913'.
       DATA DIVISION.
       WORKING-STORAGE SECTION.
       01 PROGRAM-NAME   PIC X(8)  VALUE 'HCIPDB01'.
       01 BZ-ASSERT.
       ...
       1 AZ-COMPARE-ITEM-NAMES.
         ...
         3 ZUT00000076.
            ...
            5 PIC X(15) DISPLAY VALUE ' OF DFHCOMMAREA'.
       1 AZ-COMPARE-WORK-ITEMS.
          3 ZUT0000005D PIC X(6) OCCURS 2.
          3 ZUT0000005F PIC 9(2) OCCURS 2.
          3 ZUT00000061 PIC 9(10) OCCURS 2.
          3 ZUT00000063 PIC X(10) OCCURS 2.
          3 ZUT00000065 PIC X(10) OCCURS 2.
          3 ZUT00000067 PIC X(20) OCCURS 2.
          3 ZUT00000069 PIC X(10) OCCURS 2.
          3 ZUT0000006B PIC X(20) OCCURS 2.
          3 ZUT0000006D PIC X(20) OCCURS 2.
          3 ZUT0000006F PIC X(10) OCCURS 2.
          3 ZUT00000071 PIC X(20) OCCURS 2.
          3 ZUT00000073 PIC X(50) OCCURS 2.
          3 ZUT00000075 PIC X(10) OCCURS 2.
          3 ZUT00000077 PIC X(32302) OCCURS 2.
       LINKAGE SECTION.
       01 AZ-TEST                   PIC X(80).
       01 AZ-ARG-LIST.
         03 ARG-LENGTH PIC 9(4) COMP-4.
      ...
      * EVALUATE OUTPUT VALUE
           MOVE 0 TO RETURN-CODE
           IF CA-REQUEST-ID OF DFHCOMMAREA = ZUT00000050 THEN
             CONTINUE
           ELSE
             MOVE CA-REQUEST-ID OF DFHCOMMAREA TO ZUT0000005D(1)
             MOVE ZUT00000050 TO ZUT0000005D(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT0000005C
             MOVE LENGTH OF ZUT0000005C TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000005D(1)
             MOVE 6 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT0000005D(2)
             MOVE 6 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           IF (CA-RETURN-CODE OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-RETURN-CODE OF DFHCOMMAREA TO ZUT0000005F(1)
             MOVE 01 TO ZUT0000005F(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT0000005E
             MOVE LENGTH OF ZUT0000005E TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000005F(1)
             MOVE 2 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT0000005F(2)
             MOVE 2 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           IF (CA-PATIENT-ID OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-PATIENT-ID OF DFHCOMMAREA TO ZUT00000061(1)
             MOVE 2 TO ZUT00000061(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000060
             MOVE LENGTH OF ZUT00000060 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000061(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000061(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-INS-CARD-NUM OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT00000063(1)
             MOVE ZUT00000051 TO ZUT00000063(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000062
             MOVE LENGTH OF ZUT00000062 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000063(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000063(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-FIRST-NAME OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT00000065(1)
             MOVE ZUT00000052 TO ZUT00000065(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000064
             MOVE LENGTH OF ZUT00000064 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000065(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000065(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-LAST-NAME OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT00000067(1)
             MOVE ZUT00000053 TO ZUT00000067(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000066
             MOVE LENGTH OF ZUT00000066 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000067(1)
             MOVE 20 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000067(2)
             MOVE 20 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-DOB OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT00000069(1)
             MOVE ZUT00000054 TO ZUT00000069(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000068
             MOVE LENGTH OF ZUT00000068 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000069(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000069(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-ADDRESS OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT0000006B(1)
             MOVE ZUT00000055 TO ZUT0000006B(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT0000006A
             MOVE LENGTH OF ZUT0000006A TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000006B(1)
             MOVE 20 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT0000006B(2)
             MOVE 20 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-CITY OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT0000006D(1)
             MOVE ZUT00000056 TO ZUT0000006D(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT0000006C
             MOVE LENGTH OF ZUT0000006C TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000006D(1)
             MOVE 20 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT0000006D(2)
             MOVE 20 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-POSTCODE OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT0000006F(1)
             MOVE ZUT00000057 TO ZUT0000006F(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT0000006E
             MOVE LENGTH OF ZUT0000006E TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000006F(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT0000006F(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-PHONE-MOBILE OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT00000071(1)
             MOVE ZUT00000058 TO ZUT00000071(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000070
             MOVE LENGTH OF ZUT00000070 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000071(1)
             MOVE 20 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000071(2)
             MOVE 20 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-EMAIL-ADDRESS OF CA-PATIENT-REQUEST OF
           DFHCOMMAREA TO ZUT00000073(1)
             MOVE ZUT00000059 TO ZUT00000073(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000072
             MOVE LENGTH OF ZUT00000072 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000073(1)
             MOVE 50 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000073(2)
             MOVE 50 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-USERID OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT00000075(1)
             MOVE ZUT0000005A TO ZUT00000075(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000074
             MOVE LENGTH OF ZUT00000074 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000075(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000075(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-ADDITIONAL-DATA OF CA-PATIENT-REQUEST OF
           DFHCOMMAREA TO ZUT00000077(1)
             MOVE ZUT0000005B TO ZUT00000077(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000076
             MOVE LENGTH OF ZUT00000076 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000077(1)
             MOVE 254 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000077(2)
             MOVE 254 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           END-IF
      * END
           DISPLAY 'TEST_SQL913 SUCCESSFUL.'
           GOBACK.
       INITIALIZE-PARM.
           EXIT.
       THROW-ASSERTION.
