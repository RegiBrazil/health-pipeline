      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-COMPARE-WORK-ITEMS.
          ...
          3 ZUT0000001E PIC X(10) OCCURS 2.
          3 ZUT00000020 PIC X(20) OCCURS 2.
          3 ZUT00000022 PIC X(50) OCCURS 2.
          3 ZUT00000024 PIC X(10) OCCURS 2.
       LINKAGE SECTION.
       01 AZ-TEST                   PIC X(80).
       01 AZ-ARG-LIST.
      ...
      * EVALUATE OUTPUT VALUE
           ...
           ZUT00000024(1)
             MOVE ZUT0000000A TO ZUT00000024(2)
      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-COMPARE-WORK-ITEMS.
          3 ZUT00000032 PIC X(6) OCCURS 2.
          3 ZUT00000034 PIC 9(2) OCCURS 2.
          3 ZUT00000036 PIC 9(10) OCCURS 2.
          3 ZUT00000038 PIC X(10) OCCURS 2.
          3 ZUT0000003A PIC X(10) OCCURS 2.
          3 ZUT0000003C PIC X(20) OCCURS 2.
          3 ZUT0000003E PIC X(10) OCCURS 2.
          3 ZUT00000040 PIC X(20) OCCURS 2.
          3 ZUT00000042 PIC X(20) OCCURS 2.
          3 ZUT00000044 PIC X(10) OCCURS 2.
          3 ZUT00000046 PIC X(20) OCCURS 2.
          3 ZUT00000048 PIC X(50) OCCURS 2.
          3 ZUT0000004A PIC X(10) OCCURS 2.
          3 ZUT0000004C PIC X(32302) OCCURS 2.
       LINKAGE SECTION.
       01 AZ-TEST                   PIC X(80).
       01 AZ-ARG-LIST.
         03 ARG-LENGTH PIC 9(4) COMP-4.
      ...
      * EVALUATE OUTPUT VALUE
           MOVE 0 TO RETURN-CODE
           IF CA-REQUEST-ID OF DFHCOMMAREA = ZUT00000025 THEN
             CONTINUE
           ELSE
             MOVE CA-REQUEST-ID OF DFHCOMMAREA TO ZUT00000032(1)
             MOVE ZUT00000025 TO ZUT00000032(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000031
             MOVE LENGTH OF ZUT00000031 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000032(1)
             MOVE 6 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000032(2)
             MOVE 6 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           IF (CA-RETURN-CODE OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-RETURN-CODE OF DFHCOMMAREA TO ZUT00000034(1)
             MOVE 0 TO ZUT00000034(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000033
             MOVE LENGTH OF ZUT00000033 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000034(1)
             MOVE 2 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000034(2)
             MOVE 2 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           IF (CA-PATIENT-ID OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-PATIENT-ID OF DFHCOMMAREA TO ZUT00000036(1)
             MOVE 2 TO ZUT00000036(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000035
             MOVE LENGTH OF ZUT00000035 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000036(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000036(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-FIRST-NAME OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT0000003A(1)
             MOVE ZUT00000027 TO ZUT0000003A(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000039
             MOVE LENGTH OF ZUT00000039 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000003A(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT0000003A(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-LAST-NAME OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT0000003C(1)
             MOVE ZUT00000028 TO ZUT0000003C(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT0000003B
             MOVE LENGTH OF ZUT0000003B TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000003C(1)
             MOVE 20 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT0000003C(2)
             MOVE 20 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-DOB OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT0000003E(1)
             MOVE ZUT00000029 TO ZUT0000003E(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT0000003D
             MOVE LENGTH OF ZUT0000003D TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000003E(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT0000003E(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-CITY OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT00000042(1)
             MOVE ZUT0000002B TO ZUT00000042(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000041
             MOVE LENGTH OF ZUT00000041 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000042(1)
             MOVE 20 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000042(2)
             MOVE 20 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-POSTCODE OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT00000044(1)
             MOVE ZUT0000002C TO ZUT00000044(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000043
             MOVE LENGTH OF ZUT00000043 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000044(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000044(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-PHONE-MOBILE OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT00000046(1)
             MOVE ZUT0000002D TO ZUT00000046(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000045
             MOVE LENGTH OF ZUT00000045 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000046(1)
             MOVE 20 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000046(2)
             MOVE 20 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-EMAIL-ADDRESS OF CA-PATIENT-REQUEST OF
           DFHCOMMAREA TO ZUT00000048(1)
             MOVE ZUT0000002E TO ZUT00000048(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000047
             MOVE LENGTH OF ZUT00000047 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000048(1)
             MOVE 50 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000048(2)
             MOVE 50 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           ELSE
             MOVE CA-USERID OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT0000004A(1)
             MOVE ZUT0000002F TO ZUT0000004A(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000049
             MOVE LENGTH OF ZUT00000049 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000004A(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT0000004A(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           DFHCOMMAREA TO ZUT0000004C(1)
             MOVE ZUT00000030 TO ZUT0000004C(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT0000004B
             MOVE LENGTH OF ZUT0000004B TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT0000004C(1)
      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-TEST-EXPECTED-DATA-VALUE.
          3 ZUT0000004D.
            5 PIC X(6) DISPLAY VALUE '01IPAT'.
          3 ZUT0000004E.
            5 PIC X(10) DISPLAY VALUE '2714323455'.
          3 ZUT0000004F.
            5 PIC X(4) DISPLAY VALUE 'John'.
            5 PIC X(6) DISPLAY VALUE SPACES.
          3 ZUT00000050.
          ...
          3 ZUT00000052.
            5 PIC X(15) DISPLAY VALUE '70 Bellevue Ave'.
            5 PIC X(5) DISPLAY VALUE SPACES.
          3 ZUT00000053.
            5 PIC X(7) DISPLAY VALUE 'Newport'.
            5 PIC X(13) DISPLAY VALUE SPACES.
          3 ZUT00000054.
          ...
          3 ZUT00000056.
            ...
            5 PIC X(29) DISPLAY VALUE SPACES.
          3 ZUT00000057.
            5 PIC X(5) DISPLAY VALUE 'johnn'.
            5 PIC X(5) DISPLAY VALUE SPACES.
          3 ZUT00000058.
            5 PIC X(32302) DISPLAY VALUE SPACES.
       01 AZ-COMPARE.
       ...
       1 AZ-COMPARE-WORK-ITEMS.
          ...
          3 ZUT00000062 PIC X(10) OCCURS 2.
          3 ZUT00000064 PIC X(20) OCCURS 2.
          3 ZUT00000066 PIC X(10) OCCURS 2.
          3 ZUT00000068 PIC X(20) OCCURS 2.
          3 ZUT0000006A PIC X(20) OCCURS 2.
          3 ZUT0000006C PIC X(10) OCCURS 2.
          3 ZUT0000006E PIC X(20) OCCURS 2.
          3 ZUT00000070 PIC X(50) OCCURS 2.
          3 ZUT00000072 PIC X(10) OCCURS 2.
          3 ZUT00000074 PIC X(32302) OCCURS 2.
       LINKAGE SECTION.
       01 AZ-TEST                   PIC X(80).
       01 AZ-ARG-LIST.
         03 ARG-LENGTH PIC 9(4) COMP-4.
      ...
      * EVALUATE OUTPUT VALUE
           MOVE 0 TO RETURN-CODE
           IF CA-REQUEST-ID OF DFHCOMMAREA = ZUT0000004D THEN
             CONTINUE
           ELSE
             MOVE CA-REQUEST-ID OF DFHCOMMAREA TO ZUT0000005A(1)
             MOVE ZUT0000004D TO ZUT0000005A(2)
           ...
           END-IF
           IF (CA-PATIENT-ID OF DFHCOMMAREA IS NUMERIC)
               AND (CA-PATIENT-ID OF DFHCOMMAREA = 3) THEN
             CONTINUE
           ELSE
             MOVE CA-PATIENT-ID OF DFHCOMMAREA TO ZUT0000005E(1)
           ...
           ELSE
             MOVE CA-INS-CARD-NUM OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT00000060(1)
             MOVE ZUT0000004E TO ZUT00000060(2)
           ...
           ELSE
             MOVE CA-FIRST-NAME OF CA-PATIENT-REQUEST OF DFHCOMMAREA
           TO ZUT00000062(1)
             MOVE ZUT0000004F TO ZUT00000062(2)
           ...
           ELSE
             MOVE CA-LAST-NAME OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT00000064(1)
             MOVE ZUT00000050 TO ZUT00000064(2)
           ...
           ELSE
             MOVE CA-DOB OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT00000066(1)
             MOVE ZUT00000051 TO ZUT00000066(2)
           ...
           ELSE
             MOVE CA-ADDRESS OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT00000068(1)
             MOVE ZUT00000052 TO ZUT00000068(2)
           ...
           ELSE
             MOVE CA-CITY OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT0000006A(1)
             MOVE ZUT00000053 TO ZUT0000006A(2)
           ...
           ELSE
             MOVE CA-POSTCODE OF CA-PATIENT-REQUEST OF DFHCOMMAREA TO
           ZUT0000006C(1)
             MOVE ZUT00000054 TO ZUT0000006C(2)
      ...
      *+---------------------------------------------------------------+
       ...
       01 AZ-TESTCASE-ID        PIC X(36)
           VALUE '85ed42e5-e713-4be0-83dd-13b32d68c38b'.
       LINKAGE SECTION.
       01 AZ-TEST               PIC X(80).
